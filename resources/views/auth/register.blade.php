            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    <div class="col-lg-4 d-none d-lg-block">
                        <img src="{{ asset('template/img/Padpar.png') }}" alt="Register image" height="512px" width="400px">
                      </div>
                    <div class="col-lg-7">
                        <div class="p-5">
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="no_hp" type="text"
                                            ...
                                            id="exampleInputno_hp" placeholder="Nomor Telepon">
                                        @error('no_hp')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input name="tanggal_lahir" type="date"
                                            ...
                                            id="exampleInputTanggalLahir" placeholder="Tanggal Lahir">
                                        @error('tanggal_lahir')
                                            <span class="invalid-feedback">{{ $message }}</span>
                                        @enderror
                                    </div>
