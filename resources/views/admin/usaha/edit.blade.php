                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="nama" class="form-control" placeholder="Nama"
                                value="{{ $detail->nama }}" readonly>
                        </div>
                        <label class="col-sm-2 col-form-label">NIK</label>
                        <div class="col-sm-4">
                            <input type="text" name="nik" class="form-control" placeholder="NIK"
                                value="{{ $detail->nik }}" readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="alamat" class="form-control" placeholder="Alamat"
                                value="{{ $detail->alamat }}" readonly>
                        </div>
                        <label class="col-sm-2 col-form-label">Telepon</label>
                        <div class="col-sm-4">
                            <input type="text" name="telepon" class="form-control" placeholder="telepon"
                                value="{{ $detail->no_hp }}" readonly>
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" name="nama_usaha" class="form-control" placeholder="Nama Usaha"
                                value="{{ $detail->nama_usaha }}">
                        </div>
                        <label class="col-sm-2 col-form-label">Tempat Usaha</label>
                        <div class="col-sm-4">
                            <input type="text" name="tempatusaha" class="form-control" placeholder="Tempat Usaha"
                                value="{{ $detail->tempat_usaha }}">
                        </div>
                    </div>
