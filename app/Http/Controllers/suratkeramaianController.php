...
class suratkeramaianController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.keramaian.index', ['detail' => $detail]);
    }
    ...
    {
        return view('admin.keramaian.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('keramaian')->with('success', 'Surat added successfully');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.keramaian.show', compact('detail'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('admin.keramaian.edit',[
            'detail'=> $detail,
            'user'=>$user,
        ]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('keramaian.edit', ['id' => $detail->id])->with('success', 'Surat updated successfully');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('keramaian')->with('success', 'Surat deleted successfully');
    }
    ...
    public function pengajuanUpdate(Request $request, $id)
    {
        ...
        return redirect()->route('keramaian')->with('success', 'Status pengajuan berhasil diubah: ' . $status);
    }
    public function cetak(string $id)
    {
        ...
        return view('admin.keramaian.cetak', compact('detail'));
    }
}
