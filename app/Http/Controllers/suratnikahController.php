...
class suratnikahController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.nikah.index', ['detail' => $detail]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('nikah')->with('success', 'Surat added successfully');
    }
    ...
    public function show(string $id)
    {
        ...
        return view('admin.nikah.show', compact('detail'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('nikah.edit', ['id' => $detail->id])->with('success', 'Surat updated successfully');
    }
    ...
    public function destroy(string $id)
    {
        ...
        return redirect()->route('nikah')->with('success', 'Surat deleted successfully');
    }
    ...
    public function pengajuanUpdate(Request $request, $id)
    {
        ...
        return redirect()->route('nikah')->with('success', 'Status pengajuan berhasil diubah: ' . $status);
    }
    public function cetak(string $id)
    {
        ...
        return view('admin.nikah.cetak', compact('detail'));
    }
}
